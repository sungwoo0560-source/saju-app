...
def menu_current_situation(pils, name, birth_year, gender):
    ...
    _HARD_REASON = {
        "편재": (
            ...
            f"편재 운이 겹치면 기회가 쏟아지는 만큼 욕심도 커지고, 재물이 손에 잡힐 듯 잡히지 않는 느낌이 강해집니다. "
            f"투자나 사업 결정을 앞두고 '지금 해야 하나, 말아야 하나' 하는 갈등이 반복되고 있을 가능성이 높습니다. "
            f"이성 관계에서도 새로운 인연이 오거나 기존 관계에 변화 바람이 불어 마음이 어수선해질 수 있는 시기입니다.",
        ),
        "정재": (
            "열심히 하고 있는데 결과가 너무 느리게 온다는 답답함을 느끼고 계신 건 아닌가요?",
            f"정재 운은 성실함이 빛을 발하는 시기이지만, 그만큼 조급함도 커집니다. "
            f"주변 사람들은 빠르게 치고 나가는 것 같은데 나만 제자리인 것 같은 느낌, "
            f"혹은 수입은 있는데 정작 손에 남는 게 없다는 허탈감을 경험하기 쉬운 운기입니다.",
        ),
        "식신": (
            "하고 싶은 것은 많은데 어디서부터 시작해야 할지 몰라 멈춰 있는 건 아닌가요?",
            f"식신 운이 흐르면 창의력과 표현 욕구가 넘쳐흘러 '뭔가 해야 한다'는 충동이 강하게 옵니다. "
            f"그런데 막상 구체적인 방향이 잡히지 않아 에너지가 분산되고, "
            f"잘 먹고 쉬고 싶은 욕구와 뭔가를 이루고 싶은 욕구가 뒤섞여 번아웃처럼 느껴지는 경우도 있습니다.",
        ),
        "상관": (
            "현재 상황이 억압적으로 느껴지거나, 주변 누군가와 심하게 부딪히고 계신 건 아닌가요?",
            f"상관 운은 기존 규칙과 권위에 저항하는 에너지가 가장 강해지는 시기입니다. "
            f"직장 상사나 조직 문화가 답답하게 느껴지고, '이렇게 살면 안 되겠다'는 생각이 올라옵니다. "
            f"이직·창업·새로운 도전 충동이 강한 한편, 말 한마디가 불필요한 갈등으로 번지기 쉬운 시기이기도 합니다.",
        ),
        "편관": (
            "외부에서 오는 압박이나 경쟁이 너무 벅차게 느껴지지는 않으신가요?",
            f"편관 운은 주변 환경이 나를 강하게 압박하는 시기입니다. "
            f"직장, 경쟁자, 법적 문제, 또는 건강상의 위기 신호가 동시에 몰려오는 느낌을 받을 수 있습니다. "
            f"몸이 먼저 반응하는 경우도 많아 이유 없이 피로하거나, 잘 자도 지쳐 있는 상태가 계속되기도 합니다.",
        ),
        "정관": (
            "책임은 무거운데 정작 인정받고 있다는 느낌이 부족해서 지치고 계신 건 아닌가요?",
            f"정관 운은 사회적 역할과 책임이 커지는 시기입니다. "
            f"승진·인정을 기대하고 열심히 달려왔는데 결과가 예상보다 더디게 따라오면, "
            f"'내가 방향을 잘못 잡은 건가' 하는 자기 의심이 생기기 시작합니다. "
            f"규범을 지키면서도 내 욕구는 억누르는 패턴이 반복되어 내면의 피로가 쌓이기 쉬운 운기입니다.",
        ),
        "편인": (
            "무언가를 시작했다가 중단하거나, 계획이 자꾸 바뀌어서 스스로 답답하지는 않으신가요?",
            f"편인 운은 새로운 아이디어와 변화 욕구가 강해지는 시기입니다. "
            f"이것저것 손을 대다 보면 집중력이 분산되고, '나는 왜 이렇게 끈기가 없을까' 하는 자책이 생깁니다. "
            f"또한 이 운기에서는 감언이설이나 달콤한 제안에 속아 에너지를 낭비하는 경우도 많으니 주의가 필요합니다.",
        ),
        "정인": (
            "공부나 준비는 열심히 하는데 막상 행동으로 옮기는 게 두려워 멈춰 있는 건 아닌가요?",
            f"정인 운은 학습과 성찰의 에너지가 강한 시기입니다. "
            f"그런데 아는 것과 실행하는 것 사이의 간격이 점점 커지면서, "
            f"완벽하게 준비될 때까지 기다리다가 기회를 놓치는 패턴이 반복되기 쉽습니다. "
            f"누군가에게 의지하고 싶은 마음도 강해져서, 혼자 결정해야 하는 상황이 유독 힘들게 느껴집니다.",
        ),
        "비견": (
            "혼자서 모든 걸 해내야 한다는 압박감이나, 주변과의 경쟁으로 외로움을 느끼고 계신 건 아닌가요?",
            f"비견 운은 자립심과 자아 의지가 최고조에 달하는 시기입니다. "
            f"그만큼 남에게 기대는 것이 어려워지고, 협력보다 경쟁 심리가 앞서게 됩니다. "
            f"주변 사람들과 미묘한 갈등이 생기거나, 가장 가까운 사람과 오히려 멀어지는 느낌을 받는 경우도 있습니다.",
        ),
        "겁재": (
            "재물이나 사람 문제로 예상치 못한 손실이나 배신감을 경험하고 계신 건 아닌가요?",
            f"겁재 운은 재물 기복이 가장 크고 인간관계의 변수가 많은 시기입니다. "
            f"믿었던 사람에게 실망하거나, 투자나 사업에서 예상치 못한 손실이 생기기 쉽습니다. "
            f"'왜 나한테만 이런 일이 생기지'라는 억울함이 쌓이기 쉬운 운기이니, 감정적 결정을 극도로 자제해야 합니다.",
        ),
    }

    # ── 대운 맥락 문장 ────────────────────────────────────
    _DW_CONTEXT = {
        "편재": f"이런 흐름이 단순히 올해만의 문제가 아닌 이유는, 현재 **{dw_kr} 대운**이라는 큰 물줄기가 이미 수년째 {name}님의 삶 전체에 흐르고 있기 때문입니다. 대운 편재는 재물과 이성의 기운이 활발하게 움직이는 시기인 만큼, 기회도 많지만 그만큼 판단 실수도 빈번해집니다.",
        "정재": f"이 흐름의 바탕에는 **{dw_kr} 대운**이 깔려 있습니다. 정재 대운은 착실함이 빛을 발하는 긴 흐름이지만, 그 안에서 '왜 이렇게 더디지?'라는 조급함을 견뎌내는 것 자체가 이 운기의 과제입니다.",
        "식신": f"이 에너지의 밑바탕에는 **{dw_kr} 대운**이 있습니다. 식신 대운은 복록과 창의력이 긴 호흡으로 쌓이는 시기입니다. 지금 느끼는 번아웃과 방향 혼란은 이 에너지가 터져 나오기 직전의 충전 기간일 수 있습니다.",
        "상관": f"이 충동의 근원에는 **{dw_kr} 대운**이 있습니다. 상관 대운은 기존의 틀을 스스로 깨뜨리도록 밀어붙이는 강한 운기입니다. 이 에너지를 억누르면 더 큰 폭발로 이어질 수 있으니, 출구를 찾아주는 것이 핵심입니다.",
        "편관": f"이 압박의 뿌리에는 **{dw_kr} 대운**이 자리합니다. 편관 대운은 강한 외부 자극으로 인해 내면이 단단해지는 운기이기도 합니다. 지금의 힘듦이 훗날 가장 큰 실력과 내공이 될 수 있습니다.",
        "정관": f"이 피로의 배경에는 **{dw_kr} 대운**이 있습니다. 정관 대운은 사회적 책임과 역할이 커지는 긴 흐름으로, 이 시기에 쌓는 신뢰와 실력이 나중에 가장 큰 자산이 됩니다.",
        "편인": f"이 변화의 흐름 아래에는 **{dw_kr} 대운**이 깔려 있습니다. 편인 대운은 영적 성장과 전문성을 쌓는 운기인데, 한 곳에 집중하지 못하면 에너지가 흩어지기 쉽습니다.",
        "정인": f"이 망설임의 배경에는 **{dw_kr} 대운**이 있습니다. 정인 대운은 실력과 지식을 깊이 쌓는 시기인 만큼, 지금의 준비가 결코 헛되지 않습니다. 다만 실행의 시기를 놓치지 않는 것이 관건입니다.",
        "비견": f"이 외로움의 뿌리에는 **{dw_kr} 대운**이 있습니다. 비견 대운은 스스로 서는 힘을 기르는 운기이지만, 그 과정에서 고독감이 동반됩니다. 이 운기를 지나면 누구에게도 기대지 않는 단단한 자립심이 생깁니다.",
        "겁재": f"이 손실의 근원에는 **{dw_kr} 대운**이 있습니다. 겁재 대운은 인간관계와 재물에서 가장 많은 시험을 치르는 시기입니다. 이 운기를 통과하면서 진짜 내 편이 누구인지, 무엇이 진짜 가치 있는지를 알게 됩니다.",
    }

    # ── 길흉 맥락 ────────────────────────────────────────
    _GIL_COMMENT = {
        "대길": f"다행히 올해 대운과 세운의 교차 기운은 **대길(大吉)**입니다. 지금의 힘든 감정이 사실은 더 큰 도약을 앞둔 에너지의 충전 상태일 수 있습니다. 지금 이 감정을 억누르지 말고, 방향만 잘 잡으면 올해 안에 흐름이 바뀝니다.",
        "길":   f"올해의 운기 교차는 **길(吉)**한 편입니다. 지금 느끼는 어려움은 잠시 지나가는 파도이며, 큰 흐름은 {name}님을 향해 열려 있습니다.",
        "평":   f"올해는 **평(平)**한 흐름입니다. 크게 나쁘지도, 크게 좋지도 않은 시기인 만큼 지금의 감정을 잘 다독이고 내실을 다지는 것이 가장 현명한 선택입니다.",
        "흉":   f"올해 운기 교차는 **흉(凶)**한 편으로 나옵니다. 이런 시기일수록 큰 결정과 변화를 최소화하고, 지금 가진 것을 지키는 데 집중하십시오. 이 운기는 반드시 지나갑니다.",
        "대흉": f"올해는 **대흉(大凶)**한 운기가 겹치는 시기입니다. 지금 느끼는 힘듦이 가장 클 수 있지만, 명리학에서 대흉 다음에 오는 운기가 가장 크게 열리는 경우가 많습니다. 지금은 버티고 지키는 것이 전략입니다.",
    }

    # ── 신강신약 맥락 ─────────────────────────────────────
    _SN_COMMENT = {
        "신강": f"{name}님은 **신강(身强) 사주**입니다. 타고난 에너지가 강하고 의지력이 뛰어납니다. 그런데 이런 사주일수록 자기 뜻대로 안 될 때 더 크게 좌절하고, 주변과의 마찰도 더 크게 느껴집니다. 지금의 힘듦이 혹시 '내가 이렇게까지 해야 하나'라는 자존심 문제와 연결되어 있지는 않으신가요?",
        "신약": f"{name}님은 **신약(身弱) 사주**입니다. 섬세하고 타인의 감정을 잘 읽는 장점이 있지만, 그만큼 외부 환경의 영향을 크게 받습니다. 지금의 힘듦이 내 문제가 아니라 주변 환경이나 사람들로부터 오는 경우가 많습니다. 나를 먼저 챙기는 것이 죄가 아닙니다.",
        "중화": f"{name}님은 **중화(中和) 사주**로 균형 잡힌 에너지를 갖추고 있습니다. 다만 지금처럼 운기가 변동하는 시기에는 그 균형이 흔들리는 느낌을 더 예민하게 느낄 수 있습니다.",
    }

    # ── 용신 처방 문장 ────────────────────────────────────
    _YONG_RX = {
        "木": "지금 가장 필요한 기운은 **목(木) — 성장과 시작의 에너지**입니다. 새벽 산책, 식물 키우기, 동쪽 방향 활동, 초록빛 환경이 이 기운을 보충해줍니다.",
        "火": "지금 가장 필요한 기운은 **화(火) — 열정과 표현의 에너지**입니다. 밝은 조명, 활발한 대인 관계, 운동, 남쪽 방향 활동이 도움이 됩니다.",
        "土": "지금 가장 필요한 기운은 **토(土) — 안정과 신뢰의 에너지**입니다. 규칙적인 식사와 수면, 황토색 환경, 중심 잡기 명상이 이 기운을 보충해줍니다.",
        "金": "지금 가장 필요한 기운은 **금(金) — 결단과 정리의 에너지**입니다. 불필요한 것들을 정리하고, 흰색이나 금속 소품을 활용하며, 원칙을 세우는 것이 도움이 됩니다.",
        "水": "지금 가장 필요한 기운은 **수(水) — 지혜와 유연성의 에너지**입니다. 물 가까이 있기, 독서와 성찰, 북쪽 방향, 검은색·파란색 활용이 이 기운을 보충해줍니다.",
    }
    ...
    if gi_str:
        ...
        lines.append(f"반면 **{_OH_KR.get(gi_str, gi_str)} 기운은 지금 {name}님에게 독이 됩니다.** 이 기운이 강해지는 상황(계절·방향·색상·사람)을 의식적으로 줄이는 것만으로도 흐름이 달라집니다.")
        lines.append("")
