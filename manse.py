...
def menu_current_situation(pils, name, birth_year, gender):
    ...
    _HARD_REASON = {
        "편재": (
            "돈 문제, 또는 가까운 이성 관계 때문에 머릿속이 복잡하지는 않으신가요?",
            f"편재 운이 겹치면 기회가 쏟아지는 만큼 욕심도 함께 커집니다. "
            f"투자나 사업 결정을 앞두고 '지금 해야 하나, 말아야 하나' 하는 갈등이 밤마다 반복되고 있을 가능성이 높습니다. "
            f"재물이 손에 잡힐 듯 잡히지 않는 느낌, 혹은 막상 잡은 줄 알았는데 손가락 사이로 빠져나가는 허탈감도 이 운기의 특징입니다. "
            f"이성 관계에서도 새로운 인연이 나타나거나 기존 관계에 갑작스러운 변화 바람이 불어 마음이 더 어수선해집니다. "
            f"지금 가장 주의할 것은 '흥분 상태에서 내리는 큰 결정'입니다. "
            f"편재 운에서는 판단력이 흐려진 채 과감한 결정을 내렸다가 나중에 후회하는 패턴이 자주 반복됩니다. "
            f"지금 {name}님에게 필요한 것은 속도보다 방향입니다."
        ),
        "정재": (
            "열심히 하고 있는데 결과가 너무 느리게 온다는 답답함을 느끼고 계신 건 아닌가요?",
            f"정재 운은 성실하고 꾸준한 사람에게 빛을 발하는 운기이지만, 그만큼 조급함도 함께 커집니다. "
            f"주변 사람들은 빠르게 치고 나가는 것 같은데 나만 제자리를 맴도는 것 같은 느낌이 들기 쉽습니다. "
            f"수입은 있는데 정작 손에 남는 게 없다는 허탈감, 지출이 예상보다 많아 불안한 마음도 이 운기에 자주 등장합니다. "
            f"또한 정재 운에서는 꼼꼼한 관리와 절약 욕구가 강해지는 대신, "
            f"기회에 과감하게 뛰어들지 못해 아깝게 놓치는 경험도 동반됩니다. "
            f"지금 {name}님에게 필요한 것은 '지금 내가 정말 성장하고 있는가'를 조급하지 않은 시선으로 바라보는 것입니다. "
            f"정재 운은 눈에 보이지 않는 곳에서 실력과 자산이 조용히 쌓이는 운기입니다."
        ),
        "식신": (
            "하고 싶은 것은 많은데 어디서부터 시작해야 할지 몰라 멈춰 있는 건 아닌가요?",
            f"식신 운이 흐르면 창의력과 표현 욕구가 넘쳐흘러 '뭔가 해야 한다'는 충동이 파도처럼 밀려옵니다. "
            f"그런데 막상 구체적인 방향이 잡히지 않아 에너지가 사방으로 분산되고, "
            f"결국 '이것도 저것도 아닌 것 같다'는 무력감이 찾아오기도 합니다. "
            f"잘 먹고 쉬고 싶은 욕구와 뭔가를 이루고 싶은 욕구가 뒤섞여 번아웃처럼 느껴지는 것, "
            f"새로운 취미나 공부를 시작했다가 얼마 안 가 흥미를 잃는 패턴도 이 운기의 특징입니다. "
            f"식신 운의 에너지는 억누르는 것이 아니라 '하나의 출구'로 집중시키는 것이 핵심입니다. "
            f"지금 {name}님에게 가장 필요한 것은 완벽하지 않아도 일단 시작하는 용기입니다."
        ),
        "상관": (
            "현재 상황이 억압적으로 느껴지거나, 주변 누군가와 심하게 부딪히고 계신 건 아닌가요?",
            f"상관 운은 기존 규칙과 권위에 저항하는 에너지가 가장 강하게 올라오는 시기입니다. "
            f"직장 상사나 조직 문화가 숨막히게 답답하게 느껴지고, '이렇게 계속 살면 안 되겠다'는 생각이 자꾸 올라옵니다. "
            f"이직·창업·완전히 새로운 도전에 대한 충동이 그 어느 때보다 강한 한편, "
            f"말 한마디가 불필요한 오해와 갈등으로 번지기 쉬운 시기이기도 합니다. "
            f"특히 상관 운에서는 참아왔던 말들이 쏟아져 나와 소중한 관계에 금이 가거나, "
            f"충동적인 결정으로 안정적이었던 것들을 스스로 무너뜨리는 경우가 많습니다. "
            f"지금 {name}님에게 필요한 것은 에너지의 출구를 '창의적 도전'으로 돌리는 지혜입니다. "
            f"바꾸고 싶은 것이 있다면 감정이 아닌 전략으로 움직이십시오."
        ),
        "편관": (
            ...
            f"도움을 요청하는 것을 약함으로 여기지 말고, 믿을 수 있는 사람에게 짐을 나누는 것이 이 운기를 건강하게 통과하는 방법입니다. "
            f"지금의 압박은 {name}님을 무너뜨리기 위한 것이 아니라, 다음 단계로 단련시키기 위한 과정입니다."
        ),
        "정관": (
            "책임은 무거운데 정작 인정받고 있다는 느낌이 부족해서 지치고 계신 건 아닌가요?",
            f"정관 운은 사회적 역할과 책임이 커지는 시기입니다. "
            f"승진·인정을 기대하며 열심히 달려왔는데 결과가 예상보다 훨씬 더디게 따라오면, "
            f"'내가 방향을 잘못 잡은 건가', '나만 손해 보는 것 같다'는 자기 의심이 스멀스멀 올라오기 시작합니다. "
            f"규범과 원칙을 지키면서도 자신의 욕구와 감정은 억누르는 패턴이 반복되어 "
            f"내면에 피로와 억울함이 쌓이는 것이 이 운기의 특징입니다. "
            f"또한 정관 운에서는 '나는 이렇게 바르게 하는데 왜 저 사람은 저래도 되는 거야'라는 불공평함이 더 크게 느껴집니다. "
            f"지금 {name}님에게 필요한 것은 인정받기 위해 하는 것이 아닌, "
            f"자신의 기준과 가치를 위해 하는 것으로 마음의 축을 옮기는 것입니다."
        ),
        "편인": (
            "무언가를 시작했다가 중단하거나, 계획이 자꾸 바뀌어서 스스로 답답하지는 않으신가요?",
            f"편인 운은 새로운 아이디어와 변화 욕구, 영적·지적 탐구심이 강해지는 시기입니다. "
            f"이것저것 손을 대다 보면 집중력이 분산되고, '나는 왜 이렇게 끈기가 없을까' 하는 자책이 반복됩니다. "
            f"특히 이 운기에서는 달콤한 제안이나 감언이설에 쉽게 끌려 에너지와 자원을 낭비하는 경우가 많으니 각별한 주의가 필요합니다. "
            f"한편으로는 혼자 있고 싶고, 아무도 이해 못 할 것 같은 고독감이 강해지기도 합니다. "
            f"편인 운의 진짜 힘은 '깊이 파고드는 집중'에서 나옵니다. "
            f"지금 {name}님에게 필요한 것은 한 가지를 선택하고 그것에만 집중하는 결단입니다. "
            f"넓게 퍼지는 것을 멈추고, 하나의 뿌리를 깊게 내리는 시기입니다."
        ),
        "정인": (
            "공부나 준비는 열심히 하는데 막상 행동으로 옮기는 게 두려워 멈춰 있는 건 아닌가요?",
            f"정인 운은 학습·성찰·내면 성장의 에너지가 강한 시기입니다. "
            f"그런데 아는 것과 실행하는 것 사이의 간격이 점점 벌어지면서, "
            f"'조금만 더 준비되면 시작하겠다'는 생각이 반복되다 보니 기회를 놓치는 패턴이 생기기 쉽습니다. "
            f"또한 누군가에게 기대고 싶은 마음, 믿고 의지할 사람이 필요하다는 감정이 강해져서 "
            f"혼자 결정해야 하는 상황이 유독 무겁게 느껴집니다. "
            f"정인 운에서 중요한 것은 '완벽한 준비'보다 '충분한 준비'가 되었을 때 실행하는 용기입니다. "
            f"지금 {name}님이 쌓고 있는 것들은 결코 헛되지 않습니다. "
            f"배움을 행동으로 연결하는 작은 실천을 의식적으로 만들어 가십시오."
        ),
        "비견": (
            "혼자서 모든 걸 해내야 한다는 압박감이나, 주변과의 경쟁으로 외로움을 느끼고 계신 건 아닌가요?",
            f"비견 운은 자립심과 자아 의지가 최고조에 달하는 시기입니다. "
            f"스스로 모든 것을 해결하려는 강한 욕구가 생기지만, 그만큼 남에게 도움을 요청하는 것이 어려워지고 "
            f"협력보다 경쟁 심리가 앞서게 됩니다. "
            f"주변 사람들과 미묘한 신경전이 생기거나, 가장 가까운 사람과 오히려 멀어지는 느낌이 드는 것도 이 운기의 특징입니다. "
            f"특히 비견 운에서는 재물이 분산되거나 경쟁으로 인한 손실이 발생하기 쉽고, "
            f"남의 일에 개입하다가 오히려 피해를 보는 상황도 생깁니다. "
            f"지금 {name}님에게 가장 필요한 것은 '경쟁'이 아닌 '협력'의 관점으로 전환하는 것입니다. "
            f"혼자 가는 것보다 함께 가는 것이 이 운기를 훨씬 건강하게 통과하는 방법입니다."
        ),
        "겁재": (
            "재물이나 사람 문제로 예상치 못한 손실이나 배신감을 경험하고 계신 건 아닌가요?",
            f"겁재 운은 재물 기복이 가장 크고 인간관계의 변수가 가장 많은 시기입니다. "
            f"믿었던 사람에게 실망하거나, 투자·사업에서 예상치 못한 손실이 생기기 쉽습니다. "
            f"'왜 나한테만 이런 일이 생기지'라는 억울함, '사람이 다 그렇지 뭐'라는 냉소가 쌓이기 쉬운 운기입니다. "
            f"겁재 운에서는 빠른 이익을 약속하는 제안, 보증이나 공동 투자 요청을 특히 조심해야 합니다. "
            f"감정이 격해진 상태에서 내리는 재정적·인간관계적 결정은 대부분 나중에 후회로 이어집니다. "
            f"지금 {name}님에게 가장 중요한 것은 감정적 결정을 극도로 자제하고, "
            f"진짜 내 편인 사람이 누구인지를 차분하게 가려내는 것입니다. "
            f"이 운기를 통과하고 나면 사람 보는 눈이 훨씬 깊어집니다."
        ),
    }
    ...
    _DW_CONTEXT = {
        "편재": (
            f"이런 흐름이 단순히 올해만의 문제가 아닌 이유는, 현재 **{dw_kr} 대운**이라는 큰 물줄기가 수년째 {name}님의 삶 전체를 관통하고 있기 때문입니다. "
            f"대운 편재는 재물과 이성, 외부 세계와의 교류가 활발하게 움직이는 긴 흐름입니다. "
            f"기회가 많은 만큼 판단 실수도 잦아지고, 충동적 결정이 나중에 발목을 잡는 패턴이 반복됩니다. "
            f"이 대운 안에서 올해의 운기가 더해지고 있으니, 지금 느끼는 혼란은 어느 정도 구조적인 흐름이기도 합니다. "
            f"방향만 잘 잡는다면 편재 대운은 큰 도약의 발판이 될 수 있습니다."
        ),
        "정재": (
            f"이 흐름의 바탕에는 **{dw_kr} 대운**이 깔려 있습니다. "
            f"정재 대운은 꾸준하고 성실한 사람에게 서서히 빛이 나는 긴 흐름입니다. "
            f"단기간에 드라마틱한 변화를 기대하기보다, 묵묵히 실력과 자산을 쌓아가는 것이 이 운기의 핵심 과제입니다. "
            f"'왜 이렇게 더디지?'라는 조급함 자체를 이겨내는 것이 정재 대운이 {name}님에게 내리는 숙제입니다. "
            f"서두르지 않을수록 더 단단한 것이 쌓입니다."
        ),
        "식신": (
            f"이 에너지의 밑바탕에는 **{dw_kr} 대운**이 있습니다. "
            f"식신 대운은 복록·창의·표현의 기운이 긴 호흡으로 쌓이는 시기입니다. "
            f"지금 느끼는 번아웃과 방향 혼란은 이 에너지가 터져 나오기 직전의 충전 기간일 수 있습니다. "
            f"이 대운에서는 억지로 밀어붙이는 것보다 자신이 진정으로 즐기는 것을 찾는 것이 훨씬 강한 동력이 됩니다. "
            f"먹고, 즐기고, 표현하는 것에서 답을 찾으십시오."
        ),
        "상관": (
            f"이 충동의 근원에는 **{dw_kr} 대운**이 있습니다. "
            f"상관 대운은 기존의 틀과 제약을 스스로 깨뜨리도록 강하게 밀어붙이는 운기입니다. "
            f"이 에너지를 억누르면 더 큰 폭발이나 건강 문제로 이어질 수 있습니다. "
            f"출구를 막는 것이 아니라, 그 에너지를 창의적 도전이나 표현으로 돌려주는 것이 핵심입니다. "
            f"상관 대운이 끝날 때 {name}님은 이전과 완전히 다른 사람이 되어 있을 것입니다."
        ),
        "편관": (
            f"이 압박의 뿌리에는 **{dw_kr} 대운**이 자리합니다. "
            f"편관 대운은 강한 외부 자극이 연속되는 시기로, 마치 거센 바람 속에 서 있는 느낌이 오래 이어집니다. "
            f"그러나 명리학에서 편관 대운을 견뎌낸 사람은 그 어떤 상황에서도 흔들리지 않는 강인한 내공을 얻게 됩니다. "
            f"지금의 힘듦은 단련의 과정입니다. "
            f"이 운기를 지나면 {name}님이 얼마나 강해졌는지 스스로 놀라게 될 것입니다."
        ),
        "정관": (
            f"이 피로의 배경에는 **{dw_kr} 대운**이 있습니다. "
            f"정관 대운은 사회적 역할과 책임이 커지고, 신뢰와 실력이 중요해지는 긴 흐름입니다. "
            f"성과가 즉각적으로 드러나지 않더라도, 이 시기에 쌓는 원칙과 신뢰가 나중에 가장 큰 자산이 됩니다. "
            f"지금 {name}님이 하는 모든 노력은 반드시 빛을 발할 때가 옵니다. "
            f"조급해하지 말고, 지금 자리에서 최선을 다하는 것이 가장 강력한 전략입니다."
        ),
        "편인": (
            f"이 변화의 흐름 아래에는 **{dw_kr} 대운**이 깔려 있습니다. "
            f"편인 대운은 특별한 전문성이나 영적·지적 깊이를 쌓는 시기인데, "
            f"한 곳에 집중하지 못하면 에너지가 사방으로 흩어져 아무것도 이루지 못하는 허탈감이 찾아올 수 있습니다. "
            f"이 운기에서 가장 강력한 무기는 '한 가지에 깊이 파고드는 집중력'입니다. "
            f"주변의 유혹과 변화에 흔들리지 말고, {name}님만의 전문 분야를 키워가십시오."
        ),
        "정인": (
            f"이 망설임의 배경에는 **{dw_kr} 대운**이 있습니다. "
            f"정인 대운은 지식·학문·내면 성장이 깊어지는 긴 흐름입니다. "
            f"지금의 준비와 공부는 결코 헛되지 않으며, 이 시기에 쌓인 실력이 나중에 가장 탄탄한 기반이 됩니다. "
            f"다만 배움이 너무 길어지면 실행의 시기를 놓칠 수 있습니다. "
            f"완벽하게 준비되기를 기다리지 말고, '충분히' 준비됐을 때 움직이는 결단이 필요합니다."
        ),
        "비견": (
            f"이 외로움의 뿌리에는 **{dw_kr} 대운**이 있습니다. "
            f"비견 대운은 스스로 서는 힘을 기르는 운기이지만, 그 과정에서 필연적으로 고독감이 동반됩니다. "
            f"주변과의 경쟁과 갈등, 재물 분산과 독립 과정이 이 운기의 핵심 과제입니다. "
            f"이 운기를 온전히 통과하고 나면 {name}님은 어떤 환경에서도 홀로 설 수 있는 단단한 자립심을 갖게 됩니다. "
            f"지금의 고독은 성장통입니다."
        ),
        "겁재": (
            f"이 손실과 배신감의 근원에는 **{dw_kr} 대운**이 있습니다. "
            f"겁재 대운은 인간관계와 재물에서 가장 많은 시험을 치르는 시기로, "
            f"믿었던 사람에게 상처받고, 애써 쌓은 것이 흔들리는 경험이 반복되기 쉽습니다. "
            f"그러나 이 과정을 통해 {name}님은 진짜 내 편이 누구인지, 진짜 가치 있는 것이 무엇인지를 알게 됩니다. "
            f"겁재 대운이 끝날 때 남은 것들이 바로 {name}님 삶의 진짜 자산입니다."
        ),
    }
    ...
    _GIL_COMMENT = {
        "대길": (
            f"다행히 올해 대운과 세운의 교차 기운은 **대길(大吉)**입니다. "
            f"지금의 힘든 감정이 사실은 더 큰 도약을 앞둔 에너지의 충전 상태일 수 있습니다. "
            f"명리학에서 대길 운기에 드는 고통은 대부분 '성장통'입니다. "
            f"지금 이 감정을 억누르지 말고 방향만 잘 잡으면, 올해 안에 흐름이 바뀌는 것을 체감하게 됩니다. "
            f"지금이 바로 행동할 때입니다."
        ),
        "길": (
            f"올해의 운기 교차는 **길(吉)**한 편입니다. "
            f"지금 느끼는 어려움은 잠시 지나가는 파도이며, 큰 흐름은 {name}님을 향해 열려 있습니다. "
            f"완전히 물러설 필요는 없습니다. 다만 지나치게 무리하거나 욕심을 부리지 않는 것이 이 운기를 잘 활용하는 방법입니다. "
            f"지금의 흐름을 믿고 꾸준히 나아가십시오."
        ),
        "평": (
            f"올해는 **평(平)**한 흐름입니다. "
            f"드라마틱한 변화나 큰 행운도, 큰 위기도 없는 시기입니다. "
            f"이런 시기가 오히려 내실을 다지고 실력을 쌓기 가장 좋은 때입니다. "
            f"지금 당장의 성과에 집착하기보다 다음 기회를 위한 기반을 조용히 다져가는 것이 가장 현명한 선택입니다. "
            f"평탄한 길이 지루하게 느껴지더라도, 이 시간이 쌓여 나중의 도약이 가능해집니다."
        ),
        "흉": (
            f"올해 운기 교차는 **흉(凶)**한 편으로 나옵니다. "
            f"지금 느끼는 어려움이 단순한 기분이 아닐 수 있습니다. "
            f"이런 시기일수록 큰 결정과 변화를 최소화하고, 지금 가진 것을 지키는 데 집중하는 것이 핵심 전략입니다. "
            f"새로운 투자, 이직, 중요한 인간관계 변화는 운기가 바뀌는 시점을 기다리십시오. "
            f"흉한 운기는 반드시 지나갑니다. 지금은 버티는 것이 이기는 것입니다."
        ),
        "대흉": (
            f"올해는 **대흉(大凶)**한 운기가 겹치는 시기입니다. "
            f"지금 느끼는 힘듦이 가장 크게 느껴지는 것은 운기 상으로도 그럴 수밖에 없는 시기이기 때문입니다. "
            f"자신을 탓하거나 원망하지 마십시오. "
            f"명리학에서 대흉 다음에 오는 운기가 가장 크게 열리는 경우가 많습니다. "
            f"지금은 버티고, 지키고, 절대 포기하지 않는 것이 전략입니다. "
            f"이 시기를 통과한 {name}님은 이전과 완전히 다른 사람이 되어 있을 것입니다."
        ),
    }
    ...
    _SN_COMMENT = {
        "신강": (
            f"{name}님은 **신강(身强) 사주**입니다. "
            f"타고난 에너지가 강하고 의지력이 뛰어나며, 웬만한 어려움은 정면 돌파로 해결해온 삶을 살아왔을 가능성이 높습니다. "
            f"그런데 이런 사주일수록 자기 뜻대로 안 될 때 더 크게 좌절하고, "
            f"주변과의 마찰도 훨씬 더 크게 느껴집니다. "
            f"지금의 힘듦이 혹시 '내가 이렇게까지 해야 하나', '왜 내 노력이 인정받지 못하는가'라는 "
            f"자존심과 자존감의 문제와 연결되어 있지는 않으신가요? "
            f"신강 사주의 에너지를 '발산'하는 것이 막힐 때 가장 큰 고통이 옵니다. "
            f"지금 이 에너지를 건강하게 흘려보낼 출구를 만드는 것이 가장 시급한 과제입니다."
        ),
        "신약": (
            f"{name}님은 **신약(身弱) 사주**입니다. "
            f"섬세한 감수성과 타인의 감정을 잘 읽는 공감 능력이 큰 장점이지만, "
            f"그만큼 외부 환경의 변화와 주변 사람들의 감정에 쉽게 영향을 받습니다. "
            f"지금 느끼는 힘듦의 상당 부분이 사실은 '내 문제'가 아니라 "
            f"주변 환경이나 사람들로부터 흘러 들어온 것일 수 있습니다. "
            f"신약 사주에서 가장 위험한 것은 타인의 기대와 요구에 맞추다 스스로를 소진시키는 것입니다. "
            f"지금 {name}님에게 가장 필요한 것은 나를 먼저 챙기는 것, 그것이 죄가 아님을 인정하는 것입니다. "
            f"내면을 채워주는 활동과 자신을 지지해주는 사람들을 의식적으로 곁에 두십시오."
        ),
        "중화": (
            f"{name}님은 **중화(中和) 사주**로 오행의 균형이 비교적 잘 잡혀 있는 안정적인 구조입니다. "
            f"어떤 분야에서도 고른 능력을 발휘할 수 있지만, 반대로 특별히 두드러지는 강점이 보이지 않아 "
            f"'나는 뭘 잘하는 걸까'라는 정체성 혼란이 오기도 합니다. "
            f"운의 흐름에 따라 신강·신약으로 기울 수 있으므로 "
            f"현재 대운·세운의 성격을 파악하고 그에 맞게 유연하게 전략을 조정하는 것이 중화 사주의 핵심입니다. "
            f"지금처럼 운기가 변동하는 시기에는 균형이 흔들리는 느낌을 더 예민하게 받을 수 있습니다. "
            f"중심을 잡는 것 자체가 이 시기 {name}님의 가장 중요한 실력입니다."
        ),
    }
    ...
    _YONG_RX = {
        "木": (
            f"지금 {name}님에게 가장 필요한 기운은 **목(木) — 성장·시작·도전의 에너지**입니다. "
            f"木기운이 약해지면 결단력이 떨어지고 새로운 것을 시작하기가 두려워집니다. "
            f"**보강 방법:** 새벽 또는 아침 산책(동쪽 방향), 실내 식물 키우기, 초록색 소품·옷 활용, "
            f"작은 것부터 새로운 도전을 시작하는 것, 봄 제철 채소(부추·시금치·쑥) 섭취가 도움이 됩니다. "
            f"지금 머릿속으로만 구상하던 것 하나를 실제로 시작해보십시오."
        ),
        "火": (
            f"지금 {name}님에게 가장 필요한 기운은 **화(火) — 열정·표현·사교의 에너지**입니다. "
            f"火기운이 약해지면 의욕이 떨어지고 인간관계가 위축되며 표현하기가 어려워집니다. "
            f"**보강 방법:** 밝고 활발한 사람들과의 교류, 빛이 잘 드는 환경, 붉은색·주황색 활용, "
            f"유산소 운동·댄스·등산처럼 몸을 뜨겁게 만드는 활동, 남쪽 방향 활동, "
            f"쑥·고추·파프리카처럼 따뜻한 성질의 음식 섭취가 도움이 됩니다."
        ),
        "土": (
            f"지금 {name}님에게 가장 필요한 기운은 **토(土) — 안정·신뢰·중심의 에너지**입니다. "
            f"土기운이 약해지면 불안감이 커지고 한 가지에 집중하기 어려워집니다. "
            f"**보강 방법:** 규칙적인 식사 시간과 수면 루틴, 황토색·베이지색 환경과 소품, "
            f"걷기 명상·스트레칭으로 몸의 중심 잡기, 고구마·단호박·현미처럼 땅에서 나는 음식 섭취, "
            f"하루 계획을 적고 지키는 습관 들이기가 土기운을 보충해줍니다."
        ),
        "金": (
            f"지금 {name}님에게 가장 필요한 기운은 **금(金) — 결단·집중·완성의 에너지**입니다. "
            f"金기운이 약해지면 마무리가 약해지고, 중요한 순간에 흔들리는 패턴이 나타납니다. "
            f"**보강 방법:** 주변 정리·청소로 불필요한 것을 과감히 제거하기, 흰색·은색·금색 소품 활용, "
            f"서쪽 방향 활동, 마감과 원칙을 세우는 습관, 배·무·연근처럼 흰색 식재료 섭취가 도움이 됩니다."
        ),
        "水": (
            f"지금 {name}님에게 가장 필요한 기운은 **수(水) — 지혜·유연성·통찰의 에너지**입니다. "
            f"水기운이 약해지면 판단이 흐려지고 상황 파악이 느려지며, 감정에 휩쓸리기 쉬워집니다. "
            f"**보강 방법:** 강·바다·수영장 등 물 가까이 있기, 독서·명상·일기 쓰기, "
            f"북쪽 방향 활동, 검은색·파란색·남색 활용, "
            f"콩·검은깨·해산물처럼 검은색 계열 음식 섭취가 水기운을 보충해줍니다."
        ),
    }
    ...
    _GISIN_DETAIL = {
        "木": (
            f"**목(木) 기운을 지금은 줄여야 합니다.**  \n"
            f"木이 기신일 때 과도한 도전·확장·새로운 시작은 오히려 화를 부릅니다. "
            f"새 사업, 이직, 대규모 계약 등은 신중하게 검토하십시오.  \n"
            f"초록색이 많은 환경, 봄(3~5월), 동쪽 방향의 활동을 의식적으로 줄이는 것도 도움이 됩니다."
        ),
        "火": (
            f"**화(火) 기운을 지금은 줄여야 합니다.**  \n"
            f"火가 기신일 때 감정 과열·충동적 결정·과속이 가장 위험합니다. "
            f"흥분 상태에서 내리는 중요한 결정은 반드시 하루 이상 냉각 기간을 두십시오.  \n"
            f"붉은색·주황색 과다 노출, 여름(6~8월), 과격한 운동이나 술자리는 이 시기 자제하는 것이 좋습니다."
        ),
        "土": (
            f"**토(土) 기운을 지금은 줄여야 합니다.**  \n"
            f"土가 기신일 때 과도한 안주·변화 거부·고집이 발전의 발목을 잡습니다. "
            f"현실 안주가 기회를 막고 있지는 않은지 점검해보십시오.  \n"
            f"황토색·갈색 과다, 환절기(3·6·9·12월), 지나치게 안정만을 추구하는 선택은 주의가 필요합니다."
        ),
        "金": (
            f"**금(金) 기운을 지금은 줄여야 합니다.**  \n"
            f"金이 기신일 때 지나친 원칙주의·냉정함·비판이 인간관계를 해칩니다. "
            f"스스로를 옥죄는 완벽주의와 타인에 대한 냉정한 판단을 조금 내려놓으십시오.  \n"
            f"흰색·금속 소품 과다, 가을(9~11월), 원칙과 규율만 강조하는 태도는 완화하는 것이 좋습니다."
        ),
        "水": (
            f"**수(水) 기운을 지금은 줄여야 합니다.**  \n"
            f"水가 기신일 때 지나친 사색·우유부단·비밀주의가 기회를 놓치게 합니다. "
            f"생각이 너무 많아 행동이 늦어지고 있다면 지금 당장 작은 것부터 실행에 옮기십시오.  \n"
            f"검은색·파란색 과다, 겨울(12~2월), 물가에서의 지나친 사색 시간은 줄이는 것이 도움이 됩니다."
        ),
    }

    # ── 서술형 내러티브 조립 ──────────────────────────────
    hard_q, hard_body = _HARD_REASON.get(sw_kr, ("지금 어떤 부분이 가장 힘드신가요?", f"올해 {sw_kr} 기운이 흐르며 여러 변화와 도전이 찾아오고 있습니다."))
    dw_ctx  = _DW_CONTEXT.get(dw_kr, "")
    gil_cmt = _GIL_COMMENT.get(sw_gil, "")
    sn_cmt  = ""
    for k, v in _SN_COMMENT.items():
        if k in sn:
            sn_cmt = v
            break
    ...
    st.markdown(
        ...
        ".stMarkdown h3{font-size:16px!important;font-weight:800!important;margin-top:18px!important}"
        "</style>",
        unsafe_allow_html=True,
    )
    st.markdown("\n".join(lines))
...
def menu_gaewoon(pils, name, birth_year, gender):
    ...
    _HSM_RX = {
        "木":{
            "이사방위":   "동쪽·동남쪽 (침실·책상 동향 배치)",
            "천직":       "교육·출판·IT·의료·환경·원예·상담",
            "용신색상":   "초록·청록·파랑 — 지갑·옷·손목밴드에 반드시 적용",
            "용신음식":   "신맛·새싹·시금치·부추·매실·녹차 — 매일 조금씩",
            "기도시간":   "새벽 5~7시 (寅卯시) 동쪽 향해 3번 읊기",
            "풍수소품":   "거실 동쪽에 생화(식물) 배치 / 청색 수정 또는 옥(翡翠)",
            "강화비방":   "甲子일·乙丑일 아침 동쪽 창문 열고 깊게 호흡 3분 / 새 지갑 초록색으로 교체 후 만원짜리 3장 넣어두기",
            "21일집중":   "매일 새벽 동쪽 창 열기 → 초록 계열 음식 먹기 → '나는 성장하고 있다' 3번 낭독 → 21일 후 새로운 기회 문이 열림",
            "금기":       "서쪽 방향 외출 잦게 하지 말 것 / 흰색·금속 소품 침실에 두지 말 것",
        },
        "火":{
            "이사방위":   "남쪽·동남쪽 (조명 밝게, 남향 창 확보)",
            "천직":       "연예·방송·강연·마케팅·요식·에너지·디자인·뷰티",
            "용신색상":   "빨강·주황·핫핑크 — 지갑 안감·옷·스카프에 포인트",
            "용신음식":   "쓴맛·고추·계피·홍차·석류·고구마 — 아침에 섭취",
            "기도시간":   "오전 9~11시 (巳午시) 남쪽 향해 3번 읊기",
            "풍수소품":   "남쪽에 붉은 계열 그림·촛불·조명 / 봉황 소품",
            "강화비방":   "丙午일·丁巳일 정오에 붉은 종이에 소원 적어 남쪽 창가에 7일 보관 후 태우기 / 빨간 지갑으로 교체",
            "21일집중":   "매일 정오 남쪽 창가에서 5분 햇볕 쬐기 → 붉은 과일 한 가지 먹기 → '나는 빛나고 있다' 3번 낭독 → 21일 후 인맥과 기회가 폭발적으로 늘어남",
            "금기":       "북쪽 방 오래 머물지 말 것 / 검정·어두운 계열 옷 자주 입지 말 것",
        },
        "土":{
            "이사방위":   "중앙·남서쪽·동북쪽 (안정된 지역, 오래된 동네)",
            "천직":       "부동산·건설·농업·유통·금융·식품·컨설팅",
            "용신색상":   "황색·갈색·베이지·황금색 — 지갑·명함지갑·벨트",
            "용신음식":   "단맛·고구마·감자·현미·대추·꿀·된장 — 규칙적 식사",
            "기도시간":   "오후 1~3시 (未申시) 중앙(마루) 향해 3번 읊기",
            "풍수소품":   "집 중앙에 도자기·황토 화분 배치 / 황수정·타이거아이",
            "강화비방":   "戊辰일·己丑일 오후 황색 보자기에 황토 한 줌+쌀 한 줌 싸서 현관 입구 왼쪽에 21일 놓아두기 / 황색 지갑 교체",
            "21일집중":   "매일 식사 전 '오늘도 풍요롭다' 3번 낭독 → 황색 계열 음식 한 가지 → 집 중앙 정리정돈 → 21일 후 안정적 수입과 좋은 토지 인연이 열림",
            "금기":       "이사를 자주 다니지 말 것 / 집안 물건 아무렇게나 쌓아두지 말 것",
        },
        "金":{
            "이사방위":   "서쪽·북서쪽 (정돈된 신도시·아파트)",
            "천직":       "금융·법률·회계·군경·의료기기·기계·귀금속",
            "용신색상":   "흰색·실버·골드·아이보리 — 지갑·시계·반지에 적용",
            "용신음식":   "매운맛·마늘·생강·무·배·흰쌀·백색식품 — 저녁에 섭취",
            "기도시간":   "오후 5~7시 (申酉시) 서쪽 향해 3번 읊기",
            "풍수소품":   "서쪽에 금속 소품·금고·금속 액자 / 백수정·금발수정",
            "강화비방":   "庚申일·辛酉일 일몰 후 흰 천에 동전 7개 싸서 서쪽 서랍에 보관 / 흰색 지갑 교체 + 금색 스티커 부착",
            "21일집중":   "매일 저녁 서쪽 창 향해 흰 손수건 흔들기 → 흰색 음식 한 가지 → '나는 명확하고 단호하다' 3번 낭독 → 21일 후 법적·금전적 문제 해소와 결단력 강화",
            "금기":       "빨간 계열 소품 침실에 두지 말 것 / 쇠붙이 버리거나 깨뜨리는 행위 자제",
        },
        "水":{
            "이사방위":   "북쪽·북동쪽 (수변 지역, 지하수 풍부한 곳)",
            "천직":       "무역·유통·관광·철학·예술·심리·IT·해양",
            "용신색상":   "검정·짙은 네이비·딥블루 — 지갑·노트북 케이스·벨트",
            "용신음식":   "짠맛·해산물·검은콩·미역·김·흑임자 — 점심에 섭취",
            "기도시간":   "밤 9~11시 (亥子시) 북쪽 향해 3번 읊기",
            "풍수소품":   "북쪽에 어항·분수·수족관·흐르는 물 소품 / 흑수정·라피스",
            "강화비방":   "壬子일·癸亥일 밤 맑은 물 한 잔 북쪽 창가에 올려두고 소원 빌기, 다음날 아침 화초에 주기 / 검정 지갑 교체 + 은색 동전 1개 보관",
            "21일집중":   "매일 밤 북쪽 향해 '나의 지혜는 깊어지고 흐름을 탄다' 3번 낭독 → 검은 계열 음식 한 가지 → 하루 물 2L 마시기 → 21일 후 정보력과 인적 네트워크가 폭발적으로 열림",
            "금기":       "집안 물 새는 곳 즉시 수리 / 수도꼭지 잠그지 않으면 재물 흐름도 새어나감",
        },
    }
    # ── 등급별 집중 처방 ─────────────────────────────────────────
    _HSM_GRADE_ACT = {
        "최강": [
            "📌 지금 바로 실행: 새 사업·투자·이직·결혼 등 중요 결정을 이달 안에 시작하십시오",
            "📌 인맥을 최대한 넓히십시오 — 이 시기에 만나는 사람이 인생의 귀인이 됩니다",
            "📌 용신 방위로 이사·이직을 계획하고 있다면 지금이 최적기입니다",
            "📌 매일 아침 용신 색상 옷을 입고 긍정 확언 3번 — 무의식이 바뀝니다",
            "📌 수입의 10%를 사회에 환원하십시오 — 홍수맥에서 덕을 쌓으면 다음 황금기가 더 빨리 옵니다",
        ],
        "강함": [
            "📌 3개월 안에 핵심 목표 하나를 반드시 실행에 옮기십시오",
            "📌 용신 오행 직업 분야로의 전환을 구체적으로 준비하십시오",
            "📌 주 1회 이상 용신 방위 방향으로 외출·활동하십시오",
            "📌 기존에 미뤄왔던 계약·서류·등록 사항을 이달 내에 마무리하십시오",
        ],
        "보통": [
            "📌 올해만큼은 기회가 흐릅니다 — 소극적으로 있지 말고 한 가지 이상 시작하십시오",
            "📌 용신 색상 지갑으로 교체하고 매일 용신 음식 한 가지를 실천하십시오",
            "📌 새로운 사람을 만나는 자리에 적극 참여하십시오",
        ],
        "준비기": [
            "📌 지금 당장 결과보다 실력·자격·자산을 쌓는 시기입니다",
            "📌 용신 21일 집중처방을 지금 시작하십시오 — 다음 대운이 열릴 때 폭발적으로 터집니다",
            "📌 조상 제사·성묘를 챙기면 막힌 음덕이 열려 흐름이 바뀝니다",
        ],
        "수성기": [
            "📌 지출·투자·보증·동업을 일체 보류하십시오",
            "📌 기신 색상·방위·음식을 완전히 피하고 용신 처방만 집중하십시오",
            "📌 몸이 먼저입니다 — 건강검진, 수면, 운동 루틴을 지금 잡으십시오",
            "📌 수성기가 끝나는 대운 변화 시점을 미리 계산해두고 그때를 위해 내실을 다지십시오",
        ],
    }
    _HSM_SIGNALS = [
        "갑자기 좋은 사람을 만나게 됨",
        "예상치 못한 수입이나 선물이 생김",
        "오래된 문제가 한꺼번에 해결됨",
        "몸이 가볍고 기분이 이유 없이 좋아짐",
        "꿈이 밝고 선명하며 자주 기억됨",
        "오랫동안 연락 없던 사람이 갑자기 연락옴",
        "작은 행운들이 연속으로 일어남",
        "직감과 결정이 빨라지고 자신감이 생김",
        "길에서 돈을 줍거나 환불·적립금이 생김",
        "주변에서 칭찬·인정·추천을 갑자기 받게 됨",
        "새로운 아이디어·기회가 머릿속에 떠오름",
        "식욕·수면·컨디션이 갑자기 좋아짐",
    ]
    _HSM_BLOCKS = [
    ...
    _grade_acts_hsm = _HSM_GRADE_ACT.get(_hsm_grade, [])

    # ── 기신 차단 전용 처방 ───────────────────────────────────────
    _GIS_RX = {
        "木": {
            "차단방위":   "동쪽·동남쪽 — 이 방향 침실·책상 배치 즉시 변경",
            "피할색상":   "초록·청록·파랑 — 지갑·옷·침구에서 즉시 제거",
            "피할음식":   "신맛·새싹·부추·매실·녹차 — 과다 섭취 자제",
            "피할소품":   "거실·현관 식물 과잉 배치, 나무 소품 집중 금지",
            "차단비방":   "木 기운 강한 날(甲子·乙丑일) 큰 결정·서류 서명 금지 / 동쪽 창문은 커튼으로 차단",
            "대체처방":   "木을 극하는 金 기운 강화 — 흰색·은색 소품을 서쪽에 배치 / 마늘·무·배 섭취",
            "21일차단":   "매일 아침 동쪽 커튼 닫기 → 흰색 소품 서쪽 배치 → '나는 균형을 찾는다' 3번 낭독 → 21일 후 木 기신 영향력 약화",
            "주의사항":   "木 기신은 과도한 확장·무모한 도전·갑작스러운 이직으로 나타남. 충동적 결정을 반드시 3일 숙려 후 실행",
        },
        "火": {
            "차단방위":   "남쪽·동남쪽 — 이 방향 과도한 조명·붉은 계열 인테리어 철거",
            "피할색상":   "빨강·주황·핫핑크 — 지갑·옷·침구·포인트 소품 교체",
            "피할음식":   "쓴맛·고추·계피·홍차·석류 — 자극적 음식 줄이기",
            "피할소품":   "남쪽 촛불·강한 조명·붉은 계열 그림 제거",
            "차단비방":   "火 기운 강한 날(丙午·丁巳일) 감정적 결정·언쟁·계약 금지 / 남쪽 소품 검정·파랑 계열로 교체",
            "대체처방":   "火를 극하는 水 기운 강화 — 검정·네이비 소품 북쪽에 배치 / 해산물·미역·검은콩 섭취",
            "21일차단":   "매일 정오 남쪽 커튼 살짝 닫기 → 물 한 잔 마시기(火 억제) → '나는 차분하게 흐른다' 3번 낭독 → 21일 후 충동·감정 기복 안정",
            "주의사항":   "火 기신은 감정 과열·충동 구매·인간관계 갈등으로 나타남. 흥분 상태에서 금전 결정 절대 금지",
        },
        "土": {
            "차단방위":   "중앙·남서쪽·동북쪽 — 이 방향 황토·도자기 소품 최소화",
            "피할색상":   "황색·갈색·베이지·황금색 — 지갑·명함지갑·카펫 교체",
            "피할음식":   "단맛·고구마·감자·꿀·대추 — 과식·불규칙 식사 자제",
            "피할소품":   "집 중앙 도자기·황토 소품·무거운 가구 과잉 금지",
            "차단비방":   "土 기운 강한 날(戊辰·己丑일) 부동산 계약·투자 결정 금지 / 황색 계열 지갑 즉시 다른 색으로 교체",
            "대체처방":   "土를 극하는 木 기운 강화 — 초록 식물·파랑 소품 동쪽에 배치 / 새싹·채소·신맛 음식 섭취",
            "21일차단":   "매일 집 중앙 짐·잡동사니 정리(土 기신=정체) → 초록 화분 동쪽 추가 → '나는 변화와 성장을 받아들인다' 3번 낭독 → 21일 후 고집·답보 기운 해소",
            "주의사항":   "土 기신은 과도한 안주·변화 거부·소화 장애로 나타남. 현상 유지에 안주할수록 손실 커짐",
        },
        "金": {
            "차단방위":   "서쪽·북서쪽 — 이 방향 금속 소품·칼·시계 집중 배치 금지",
            "피할색상":   "흰색·은색·금색·아이보리 — 지갑·시계·반지 교체",
            "피할음식":   "매운맛·마늘·생강·무·배 — 과다 섭취 자제",
            "피할소품":   "서쪽 금속 소품·금고·날카로운 오브제 제거",
            "차단비방":   "金 기운 강한 날(庚申·辛酉일) 법적 서류·계약·수술 결정 금지 / 서쪽 금속 소품을 붉은 천으로 감싸거나 이동",
            "대체처방":   "金을 극하는 火 기운 강화 — 빨강·주황 소품 남쪽에 배치 / 고추·계피·홍차 섭취",
            "21일차단":   "매일 저녁 서쪽 금속 소품 1개씩 다른 방으로 이동 → 빨간 점 스티커를 서쪽 벽에 부착 → '나는 유연하게 흐른다' 3번 낭독 → 21일 후 냉정함·원칙주의 과잉 완화",
            "주의사항":   "金 기신은 지나친 원칙주의·냉정함·비판으로 인간관계 손상. 결단 전 반드시 상대 감정 먼저 확인",
        },
        "水": {
            "차단방위":   "북쪽·북동쪽 — 이 방향 어항·분수·물 소품 제거",
            "피할색상":   "검정·짙은 네이비·딥블루 — 지갑·가방·옷에서 제거",
            "피할음식":   "짠맛·해산물·미역·검은콩·검은깨 — 과다 섭취 자제",
            "피할소품":   "북쪽 어항·분수·물 오브제 다른 방으로 이동",
            "차단비방":   "水 기운 강한 날(壬子·癸亥일) 계약·투자·여행 시작 금지 / 욕실 수도꼭지·배관 누수 즉시 수리",
            "대체처방":   "水를 극하는 土 기운 강화 — 황색·갈색 도자기 소품 중앙에 배치 / 고구마·현미·단맛 음식 섭취",
            "21일차단":   "매일 밤 북쪽 어항·물 소품을 덮개로 가리기 → 황토색 러그·쿠션 거실 중앙 배치 → '나는 명확하게 결정한다' 3번 낭독 → 21일 후 우유부단·과잉 사색 기운 해소",
            "주의사항":   "水 기신은 지나친 사색·우유부단·비밀주의로 기회를 놓침. 생각보다 행동을 먼저 — 3초 결단 훈련 필요",
        },
    }
...
<span style="font-size:14px; font-weight:800; color:#d4af37;">📅 생년월일</span>
    ...
    if submitted or _auto_submit or _ss.get("saju_pils") is not None:
        if submitted or _auto_submit:
            ...
            except Exception as _pils_err:
                _saju_log.warning("[get_pillars] 계산 오류: %s", str(_pils_err)[:120])
