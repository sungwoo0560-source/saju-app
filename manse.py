        ...
        with st.expander("⚙️ 고급 설정 (야자시 · 출생지)", expanded=False):
            ...
            st.selectbox(
                ...
                options=[
                    ...
                    # 경기도
                    "경기", "수원", "고양", "용인", "부천", "성남", "안산", "안양",
                    "평택", "의정부", "파주", "김포", "화성", "남양주", "시흥", "하남",
                    # 강원도
                    "강원", "춘천", "원주", "강릉", "속초", "동해", "삼척", "태백",
                    "홍천", "양구", "인제", "고성(강원)",
                    # 충청북도
                    "충북", "청주", "충주", "제천", "진천", "음성", "영동",
                    # 충청남도
                    "충남", "천안", "공주", "아산", "서산", "보령", "홍성", "당진", "논산",
                    # 전라북도
                    "전북", "전주", "군산", "익산", "남원", "정읍", "김제", "완주",
                    # 전라남도
                    "전남", "목포", "여수", "순천", "광양", "나주", "무안", "해남", "고흥",
                    # 경상북도
                    "경북", "포항", "경주", "구미", "안동", "영주", "상주", "문경",
                    "경산", "김천", "칠곡",
                    # 경상남도
                    "경남", "창원", "진주", "통영", "거제", "밀양", "거창", "합천",
                    "고성(경남)", "사천", "양산", "함안",
                    # 제주도
                    "제주", "제주도", "서귀포",
                ],
