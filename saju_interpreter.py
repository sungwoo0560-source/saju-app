...
class LocalSajuNarrator:
    ...
    def relations(pils, name, birth_year, gender, marriage="미혼"):
        ...
        if _love_peaks:
            lines.append(
                f"\n향후 10년 중 {name}님에게 " + ("배우자 관계가 강화되거나 주의가 필요한 시기:" if marriage in ('기혼','유부남','유부녀') else "인연과 결혼 기운이 가장 활성화되는 시기:")
            )
