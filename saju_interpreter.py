    ...
    def full_report(pils, name, birth_year, gender):
        ...
        _NATURE_LONG = {
            "甲": (
                ...
                f"하늘을 향해 곧게 뻗어 오르는 거목처럼, 어떤 난관에 부딪히더라도 "
                f"돌파구를 잘 만들어내며 고비의 순간을 피하기보다 정면으로 부딪혀 이겨내는 강인함을 지니고 있기 때문에 "
                f"주변 사람들에게 믿음직스러운 사람으로 평가를 받습니다. "
                f"하지만 {name}님은 자신이 지니고 있는 강직하고 냉철한 성격으로 인해 다소 융통성이 부족한 편이며, "
                f"사사로이 사람들과 정을 나누지 않기 때문에 스스로를 고독하게 만드는 경향도 있습니다. "
                f"또한 내면적으로 기회주의적인 모습을 지니고 있으며, 직감적으로 살아가는 경향도 지니고 있습니다. "
                f"항상 자신에게 다가오는 기회에 대해서 매우 적극적으로 도전하는 편이며, "
                f"자신이 잘 알지 못하는 부분에 있어서는 직감에 의존하여 결정하는 경우가 많습니다."
            ),
            "乙": (
                f"{name}님은 **을목(乙木)**의 기운을 타고나셨습니다. "
                f"끈질긴 덩굴 식물처럼 어떤 환경에서도 적응하고 살아남는 놀라운 생명력이 있습니다. "
                f"겉으로는 부드럽고 온화해 보이지만 내면은 매우 강인한 외유내강(外柔內剛)형입니다. "
                f"{name}님은 사람을 잘 파악하고 분위기를 읽는 능력이 뛰어나며, "
                f"세밀한 관찰력으로 상대방의 마음을 먼저 헤아리는 감성적인 면이 있습니다. "
                f"다만 지나치게 눈치를 보거나 우유부단한 모습으로 정작 중요한 결정을 미루는 경향이 있어, "
                f"때로는 자신의 의지를 분명히 표현하는 연습이 필요합니다."
            ),
            "丙": (
                f"{name}님은 하늘의 태양과 같은 **병화(丙火)**의 기운을 타고나셨습니다. 태양이 온 세상을 골고루 비추듯, {name}님은 누구에게나 따뜻하고 공평하게 "
                f"대하는 밝은 성품을 지니고 있습니다. 숨기는 것이 없고 솔직하며 다정다감하여 처음 만나는 사람에게도 금방 친근감을 주는 천성적인 매력이 있습니다. 주변을 "
                f"환하게 밝히는 존재감으로 어느 자리에서든 자연스럽게 중심이 되는 경우가 많습니다. {name}님은 적극적이고 추진력이 강하여 새로운 일에 먼저 뛰어드는 "
                f"선구자적 기질이 있으며, 한번 불붙은 열정은 주변 사람들까지 움직이게 만드는 강력한 동력이 됩니다. 하지만 때로는 지나치게 감정적으로 반응하거나 충동적인 "
                f"결정을 내리는 경향도 있습니다. 흥미가 식으면 금방 다른 곳으로 관심이 옮겨가는 산만함도 경계해야 할 부분입니다. 열정이 넘치는 만큼 지속력을 기르고, 한 "
                f"가지에 깊이 집중하는 습관을 들이는 것이 인생의 핵심 과제입니다."
            ),
            "丁": (
                f"{name}님은 어둠을 밝히는 촛불과 같은 **정화(丁火)**의 기운을 타고나셨습니다. 태양처럼 화려하지는 않지만, 촛불이 어두운 방 하나를 따뜻하게 채우듯 "
                f"{name}님은 가까운 사람들의 삶에 조용하지만 깊은 온기를 전하는 존재입니다. 겉으로는 조용하고 차분해 보이지만 내면에는 강한 열정과 신념이 숨어 있는 "
                f"외유내강형입니다. 섬세한 감성과 뛰어난 직관력으로 예술·교육·상담 분야에서 특히 재능을 발휘하며, 사람의 마음을 읽는 능력이 뛰어나 주변에서 믿고 의지하는 "
                f"조언자 역할을 하는 경우가 많습니다. {name}님은 주변 사람들을 위해 헌신하는 희생정신이 강합니다. 그러나 그로 인해 자신을 돌보는 것을 소홀히 하거나, "
                f"베풀다 지쳐 번아웃이 오기도 합니다. 감정 기복을 다스리고 자신의 내면을 충전하는 시간을 의식적으로 확보하는 것이 무엇보다 중요합니다."
            ),
            "戊": (
                f"{name}님은 든든하고 스케일 큰 거대한 산과 같은 **무토(戊土)**의 기운을 타고나셨습니다. 산이 천재지변에도 흔들리지 않듯, {name}님은 어떤 "
                f"위기와 혼란 속에서도 중심을 잃지 않는 묵직한 안정감을 천성적으로 지니고 있습니다. 중후한 무게감과 넓은 포용력으로 주변 사람들의 신뢰와 존경을 받는 경우가 "
                f"많습니다. 어떤 상황에서도 흔들리지 않는 믿음직스러움이 있어 중재자나 리더 역할을 자연스럽게 맡게 됩니다. 또한 사람을 차별하지 않고 모두를 품으려는 포용력이 "
                f"강하여 다양한 사람들이 {name}님 주변에 모이는 경향이 있습니다. 하지만 변화를 싫어하고 보수적인 성향이 강하여 새로운 환경에 적응하는 데 시간이 "
                f"걸립니다. 지나친 고집과 완고함이 때로는 발전의 걸림돌이 될 수 있으니 열린 마음으로 새로운 것을 받아들이는 유연한 사고를 기르는 것이 필요합니다."
            ),
            "己": (
                f"{name}님은 만물을 키워내는 비옥한 논밭과 같은 **기토(己土)**의 기운을 타고나셨습니다. 논밭이 씨앗 하나하나를 세심하게 품어 싹을 틔우듯, "
                f"{name}님은 주변 사람들의 작은 필요와 감정 하나하나에 섬세하게 반응하는 타고난 돌봄의 기질이 있습니다. 현실 감각이 매우 탁월하고 세밀하며 실속을 "
                f"중시하는 현실주의적 기질이 강합니다. 꼼꼼하고 성실하여 맡은 일을 끝까지 완수하는 책임감이 있으며, 상대방을 배려하고 자상하게 돌보는 따뜻한 면도 지니고 "
                f"있습니다. 이런 성품 덕분에 {name}님 주변에는 항상 도움을 구하는 사람들이 끊이지 않습니다. 다만 지나친 완벽주의와 걱정이 많은 성격으로 인해 스트레스를 "
                f"자주 받는 편이며, 소심한 면이 있어 결정적인 순간에 용기를 내지 못하는 경우도 있습니다. 자신의 섬세함을 강점으로 살리되, 지나친 걱정은 내려놓는 연습이 "
                f"필요합니다."
            ),
            "庚": (
                ...
                f"주변 사람들에게 믿음직스러운 사람으로 평가를 받습니다. "
                f"하지만 {name}님은 자신이 지니고 있는 강직하고 냉철한 성격으로 인해 "
                f"다소 융통성이 부족한 편이며, 사사로이 사람들과 정을 나누지 않기 때문에 "
                f"스스로를 고독하게 만드는 경향도 있습니다. "
                f"또한 내면적으로 기회주의적인 모습을 지니고 있으며, 직감적으로 살아가는 경향도 있습니다. "
                f"항상 자신에게 다가오는 기회에 대해서 매우 적극적으로 도전하는 편이며, "
                f"자신이 잘 알지 못하는 부분에 있어서는 직감에 의존하여 결정하는 경우가 많습니다."
            ),
            "辛": (
                f"{name}님은 광석에서 정제된 보석과 같은 **신금(辛金)**의 기운을 타고나셨습니다. 보석이 오랜 시간 연마를 거쳐 아름다운 빛을 발하듯, {name}님도 "
                f"시련과 단련을 통해 더욱 빛나는 가치를 드러내는 기질이 있습니다. 날카롭고 정밀한 판단력과 예리한 미적 감각이 탁월하며, 섬세한 완벽주의로 어떤 일이든 높은 "
                f"수준의 결과물을 만들어냅니다. 비판적 사고력이 뛰어나 문제의 핵심을 꿰뚫어 보는 능력이 있지만, 때로는 이 날카로움이 타인에게 차갑게 느껴지기도 합니다. "
                f"{name}님은 자신에 대한 기준도 높아 스스로를 몰아붙이는 경향이 있습니다. 이상과 현실 사이의 간극에서 좌절을 맛볼 수 있으니, 완벽하지 않아도 충분히 "
                f"가치 있다는 것을 스스로에게 허락하는 것이 인생의 지혜입니다."
            ),
            "壬": (
                f"{name}님은 거대한 강이나 바다처럼 역동적인 **임수(壬水)**의 기운을 타고나셨습니다. 강물이 끊임없이 흘러 새로운 곳을 향하듯, {name}님은 현재에 "
                f"안주하지 않고 항상 더 넓은 세계를 향해 나아가는 기질이 있습니다. 지혜롭고 총명하며 통찰력이 뛰어나 복잡한 상황을 빠르게 파악하고 전략적으로 대응하는 능력이 "
                f"탁월합니다. 넓은 포용력과 유연한 사고로 다양한 사람들과 어울리며 광범위한 인맥을 형성합니다. {name}님은 아이디어가 풍부하고 새로운 도전을 두려워하지 "
                f"않는 모험가적 기질도 있습니다. 하지만 물이 그릇 없이 흩어지듯, 에너지가 너무 넓게 분산되어 한 가지에 깊이 집중하지 못하는 산만함이 약점이 될 수 "
                f"있습니다. 강한 추진력만큼 완성력을 갖추는 것이 {name}님 인생의 핵심 과제입니다."
            ),
            "癸": (
                f"{name}님은 안개·이슬·빗물과 같은 **계수(癸水)**의 기운을 타고나셨습니다. 이슬이 메마른 대지를 적시듯, {name}님은 건조하고 메마른 환경에서 "
                f"부드럽고 섬세한 감성으로 주변을 촉촉하게 적시는 힘이 있습니다. 뛰어난 직관력과 감수성으로 다른 사람들이 보지 못하는 것을 감지하는 능력이 있으며, "
                f"예술·상담·연구 분야에서 남다른 영감과 창의성을 발휘합니다. {name}님은 내면이 풍요롭고 사색을 즐기며 철학적인 깊이가 있습니다. 그러나 감정을 내면에 "
                f"쌓아두는 경향이 있어 스트레스를 외부로 표현하지 못하고 혼자 삭이다가 지치는 경우가 있습니다. 주변의 신뢰할 수 있는 사람에게 마음을 열고 감정을 표현하는 "
                f"연습이 필요합니다. 직감과 이성의 균형을 맞출 때 {name}님의 능력이 가장 빛납니다."
            ),
        }
        ...
        if _ys3_str:
            lines.append(
                ...
                f"이 기운의 색상이나 방향을 생활 속에서 활용하면 개운(開運)에 도움이 됩니다."
            )
        if _gs3_str:
            lines.append(
