...
⚠️ 正官이 합거(合去)되면 평생 관직과의 인연이 약해집니다. 이 경우 전문직으로 방향을 바꾸십시오.""",
...
⚠️ 偏官이 천간에 투출하면 직장 상사나 권력과의 마찰이 잦습니다. 인내와 처세가 필요합니다.
...
-> 用神: 食傷으로 재를 生하거나, 官으로 재를 洩氣할 때 균형이 맞음""",
        ...
        "caution": """⚠️ 劫財가 많으면 애써 모은 재물이 동업자나 형제로 인해 새어나갑니다. 동업을 각별히 경계하십시오.

⚠️ 財星이 너무 왕(旺)하고 印星을 극하면 학문이 중단되거나 모친과의 인연이 약해질 수 있습니다.

⚠️ 偏官이 혼잡하면 재물이 오히려 관재(官災)의 씨앗이 될 수 있으니 법을 철저히 준수하십시오.""",
...
⚠️ 여명(女命)에서 偏財格이 지나치면 부부 갈등이나 배우자의 방탕으로 인한 재물 손실이 따를 수 있습니다.""",
...
-> 梟神(偏印)이 食神을 극하면 복이 반감되니 이를 가장 경계해야 합니다""",
        ...
        "caution": """⚠️ 梟神(偏印)이 있으면 食神의 복이 꺾입니다. 이 경우 財星으로 효신을 제어해야 합니다.

⚠️ 食神이 너무 많으면 오히려 에너지가 분산되고 집중력이 떨어집니다. 하나에 집중하는 것이 중요합니다.
...
-> 가장 중요한 경계: 傷官見官! 正官과 상관이 만나면 官災/구설/직장 위기가 옵니다""",
        ...
        "caution": """⚠️ 傷官見官은 직장과 관직의 최대 위기! 관운이 올 때는 언행을 극도로 조심하십시오.
...
-> 食神을 극하는 것이 가장 큰 문제! 식신의 복을 가로막지 않도록 財星으로 편인을 제어해야 합니다""",
        ...
        "caution": """⚠️ 倒食: 偏印이 식신을 극하면 복을 스스로 차버리는 상황이 됩니다. 전문 분야 하나에 집중하는 것이 핵심입니다.
...
-> 劫財는 재물을 빼앗는 기운도 있으니, 재물 관리와 동업 관계에서 각별한 주의가 필요합니다""",
        ...
        "caution": """⚠️ 食傷이 없으면 劫財의 에너지가 분산되어 공격적이고 충동적인 행동으로 이어질 수 있습니다.
...
narratives = {
    "比肩": (
        "🤝",
        "독립과 협력의 大運: 자아의 확립",
        "比肩 大運은 주관과 독립심이 강해지는 시기로, 주도적으로 삶을 개척하게 됩니다. 동료와 협력하여 성장하는 기회가 되기도 하나, 자아 충돌과 경쟁이 예상되니 상생의 지혜가 필요합니다.",
    ),
    "劫財": (
        "⚔️",
        "투쟁과 변혁의 大運: 경쟁을 통한 도약",
        "劫財 大運은 치열한 경쟁 속에서 예기치 못한 변화와 마주하며 크게 성장하는 시기입니다. 재물 유출과 인간관계 갈등에 주의하되, 강한 추진력으로 정면 돌파하면 승리자의 위치에 서게 됩니다.",
    ),
    "食神": (
        "🍀",
        "복록과 풍요의 大運: 하늘이 내린 기회",
        "食神 大運은 재능이 꽃피고 물질적/정신적 여유가 샘솟는 축복의 10년입니다. 전문 분야에서 두각을 나타내며 건강과 복록이 따르니, 자신의 역량을 아낌없이 펼쳐 인생의 자산을 만드십시오.",
    ),
    "傷官": (
        "🌪️",
        "혁신과 영감의 大運: 틀을 깨는 도약",
    ...
    "偏財": (
        ...
        "偏財 大運은 광활한 무대에서 큰 부와 성취를 사냥하는 대담한 도전의 10년입니다. 사업이나 투자에서 예상치 못한 기회가 찾아오니, 냉철한 판단으로 과욕을 다스리며 큰 결실을 거머쥐십시오.",
    ),
    "正財": (
        "🏦",
        "안정과 축적의 大運: 성실함이 일군 부",
        "正財 大運은 정직한 노력이 꾸준한 부의 성을 쌓는 안정적인 결실의 시기입니다. 경제적 안정과 가정의 화목이 따르므로, 원칙을 지키는 자산 관리와 성실함으로 평생의 기반을 다지십시오.",
    ),
    "偏官": (
        "⚡",
        "권위와 극복의 大運: 위기를 기회로",
        "偏官 大運은 강인한 리더십으로 시련을 극복하며 사회적 명예를 드높이는 변곡점입니다. 극심한 책임감과 스트레스가 동반되지만, 정면 돌파를 통해 전설적인 성취와 권위를 얻게 될 것입니다.",
    ),
    "正官": (
        "🎖️",
        "명예와 인품의 大運: 지위의 정점",
        "正官 大運은 주변의 존경과 사회적 지위가 비약적으로 상승하는 영광스러운 시기입니다. 승진과 자격 취득 등 공적인 인정이 따르며, 단정한 품위와 원칙 준수가 당신을 성공의 정점으로 인도합니다.",
    ),
    "偏印": (
        "🔮",
        "통찰과 전문의 大運: 정신적 확장",
    ...
    "正印": (
        "📚",
        "지혜와 귀인의 大運: 훈풍이 부는 삶",
        "正印 大運은 귀인의 인도와 학문적 성취가 운명에 깃드는 평온하고 축복받은 10년입니다. 문서 잡기와 시험에 유리하며 윗사람의 후원이 따르니, 지혜를 닦아 이름 석 자를 세상에 널리 알리십시오.",
    ),
    "-": (
        "🌐",
        "조율과 준비의 大運: 균형의 시기",
